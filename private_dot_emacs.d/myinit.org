...
#+BEGIN_SRC emacs-lisp
  ...
  '(typst-ts-mode :type git :host codeberg :repo "meow_king/typst-ts-mode"))

  (use-package typst-ts-mode
    :mode "\\.typ\\'"
    :hook (typst-ts-mode . font-lock-mode)
    :bind (:map typst-ts-mode-map
              ("C-c C-c" . typst-ts-mode-compile)
    ...
    ;(setq typst-ts-watch-options "--open")
      ...
      (electric-indent-mode -1)           ; Disable auto-indent on newline
      ;; Connect to Tinymist (the LSP)
      (add-hook 'typst-ts-mode-hook #'eglot-ensure)
      (add-to-list 'auto-mode-alist '("\\.typ\\'" . typst-ts-mode)))  

  ;; Register the tinymist executable with Eglot
(with-eval-after-load 'eglot
  (add-to-list 'eglot-server-programs
               '(typst-ts-mode . ("tinymist"))))

;  (straight-use-package
;  '(typst-preview :type git :host github :repo "havarddj/typst-preview.el"))
